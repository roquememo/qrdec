...
import com.onurgunduz.qrdec.client.ReaderException;
import com.onurgunduz.qrdec.client.BitSource;
import com.onurgunduz.qrdec.client.CharacterSetECI;
import com.onurgunduz.qrdec.client.DecoderResult;
...
final class DecodedBitStreamParser {
  ...
  private static void decodeKanjiSegment(BitSource bits,
    ...
    // *OG*
    result.append(bytesToString(buffer));
  }
  ...
  private static void decodeByteSegment(BitSource bits,
    ...
    // *OG*
	result.append(bytesToString(readBytes));
